const CONFIG = {
  ...
  COMMERCE_FOOTER_RIGHT_IMG_URL: 'https://www.shuida123.com/qrcode.png', // 显示页脚右侧的图片，通常放二维码
  COMMERCE_FOOTER_RIGHT_TEXT: '扫码关注公众号，回复关键词可查询进度', // 页脚右侧图片下的文字描述
  ...
  COMMERCE_CONTACT_BILIBILI_SHOW: true // 是否展示bilibli联系按钮 请配置 CONTACT_BILIBILI
}
